...
//		System.out.println(day + "일 ");	
		System.out.printf("%02d월 ", month);		// 이렇게 하면 삼항연산자 없이 월/일을 두자릿수로 출력 가능
		System.out.printf("%02d일 ", day);		// 삼항 쓰는게 좀 빠르긴한데 무의미한 차이
												// 차라리 가독성, 유지보수 측면에서 좋은 printf를 사용
		System.out.println();
		...
		// 오전/오후 구분
		int hour24 = now2.getHour();	// 24시간제 시각: 0~24
		...
		LocalDateTime deadLine = LocalDateTime.of(2025, 8, 4, 16, 0);	// 2025년 8월 4일 오후 6시
		...
		// 차이 계산: ChronoUnit
		// 두 날짜/시간 사이의 차이를 우너하는 단위로 바로 계산
