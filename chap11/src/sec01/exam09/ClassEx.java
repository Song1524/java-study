...
public class ClassEx {
	...
	public static void main(String[] args) throws ClassNotFoundException {
		...
		System.out.println(c1.getPackageName());		// 패키지 이름
		System.out.println(c1.getName().getClass());	// 클래스의 타입
		
		// 이 외에도 필드/생성자/메소드 정보도 얻을 수 있는데
		// 이 정보를 얻어 활용하는 것을 자바에어는 "리플렉션" 이라고 부름
	}
