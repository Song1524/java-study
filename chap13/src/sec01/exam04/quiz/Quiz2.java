...
//	전체 주문 취소: []
	...
	public static void main(String[] args) {
		...
		Set<Food> data = new HashSet<Food>();
		data.add(new Food("샐러드", 14000));
		data.add(new Food("치킨", 23000));
		data.add(new Food("치킨", 50000));
		
		data.remove(new Food("치킨", 50000));
		System.out.println("5만원 치킨 취소: " + data);
		
		data.clear();
		if (data.isEmpty()) {
			System.out.println("전체 주문 취소: " + data);
		} else { 
