...
//	변경후: {Tom=[전화번호=555-123-4567, 월급=4600000], John=[전화번호=123-456-7890, 월급=4100000], Emma=[전화번호=987-654-3210, 월급=2300000]}
	...
	public static void main(String[] args) {
		...
		Map<String, Information> hashMap = new HashMap<String, Information>();
		
		Information John = new Information("123-456-7890", 3800000);
		Information Emma = new Information("987-654-3210", 2300000);
		Information Tom = new Information("555-123-4567", 4600000);
