...
public class ArrayListEx {
	...
	public static void main(String[] args) {
		...
		// 외부에세 파라미터처럼 받아서 사용할 수 있게 해주는 문법
		// 타입 파라미터: 제네릭을 사용할 때 전달하는 타입
		
//		List list = new ArrayList();	// 제네릭을 생략하면 Object로 간주(권장 안함)
//		List<String> list = new ArrayList<>();	// 생략하면 왼쪽에 지정된 타입을 따라감(타입 추론)
...
//		list.add(true);		// 제네릭 타입으로 명시된 타입의 데이터만 추가 가능
		...
		if (!list.isEmpty()) {	// 컬랙션이 비어있는지 조사
			...
			System.out.println("어디에 있니? " + list.indexOf("Database")); 	// 못 찾으면 -1출력
		}
